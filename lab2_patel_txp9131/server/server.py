                ...
                try:
                    ...
                    if(re.search("@",str(rdata))!=None and self.flag==True):
                        ...
                        if str(sub_dir[0]) == "1":
                            ...
                            print("control in creation of sub directory")
                            if(flag==0):
                                ...
                                print("entered in flag 1")
                                global temp12
                                print("sending...", temp12)
                                data = pickle.dumps(temp12)
                                self.c.send(data) 
                        if str(sub_dir[0]) == "2":
                            flag = delete_sub_directory(sub_dir[1],sub_dir[2])
                            print("inside deletion part")
                            if(flag==0):
